            ...
            <div class="card" id="c${key}" onclick="addToCart(${key});">
                ...
                <div class="info">
                    ...
                    <div class="ammountContainer">
                        ...
                        <div class="ammount" id="ca${key}">${myCart[key]?.quantity || 0}</div>
...
function addToCart(itemNumber) {
    ...
    } document.getElementById("ca"+itemNumber).textContent = myCart[itemNumber]["quantity"];
    // renderUI();
}
...
function decrease(itemNumber) {
    ...
    } document.getElementById("ca"+itemNumber).textContent = myCart[itemNumber]?.quantity ?? 0;
    // renderUI();
}
